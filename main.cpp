...
const std::string MODEL_PATH = "/Users/elijahcrain/CLionProjects/VulkanMagnets/viking_room.obj";
const std::string TEXTURE_PATH = "/Users/elijahcrain/CLionProjects/VulkanMagnets/viking_room.png";
